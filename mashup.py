...
def result_generator(sort_on, count, rev_flag):
    use_params = {
        'Inspection_Start': '2/1/2013',
        'Inspection_End': '2/1/2015',
        'Zip_Code': '98101'
    }
    sort_keys = {'avgscore': u'Average Score',
                'highscore': u'High Score',
                'inspections': u'Total Inspections'}
    ...
    metadata_list.sort(key=lambda mk: mk[sort_keys[sort_on]], 
                        reverse=(rev_flag == 'reverse'))

    for metadata in metadata_list[:count]:
        yield metadata
...
def parse_args():
    ...
    parser.add_argument('sort_on', 
                ...
                nargs='?', 
                default='avgscore', 
                help='Sort On: "avgscore", "highscore", or "inspections"')

    parser.add_argument('display_count', 
                type=int, 
                nargs='?',
                default=10, 
    ...
    parser.add_argument('reverse', 
                choices=['reverse'],
                nargs='?',
                help='Sort Order: "reverse" = high to low')
...
if __name__ == '__main__':
    ...
    for result in result_generator(args.sort_on, 
                    args.display_count, args.reverse):
